        ...
        <div className="md:w-1/2 relative h-[600px] flex items-center justify-center  md:mt-0">
          <div className="relative w-full h-full">
            ...
            <img
              ...
              alt="Decor 2"
              className="absolute w-70 h-40 top-30 left-3  shadow-2xl"
            />
            ...
            <img
              ...
              alt="Decor 4"
              className="absolute w-60 h-40 top-[350px] right-8  shadow-2xl"
            />
            ...
            <img
              ...
              alt="Decor 5"
              className="absolute w-70 h-40 bottom-0 right-[50px] -translate-x-1/2  shadow-2xl"
            />
          </div>
        </div>
      </main>
